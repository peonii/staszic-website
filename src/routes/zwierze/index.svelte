...
<p class="mx-10 shadow-2xl p-4 rounded-2xl">
    ...
    <br>
    Zatem, wybaczając, że nie ma żadnego pożywienia, zaczął wychodzić z kuchni.
    <br>
    Potem wszedł do świątyni, gdzie znalazło się wystarczająco dużo pożywienia.
    <br>
    Wszystko to zaczęło się w nieznacznym czasie.
    <br>
    Około godziny 6:00, znalazło się w świątyni wystarczająco dużo pożywienia.
    <br>
    Wszystko to zaczęło się w nieznacznym czasie.
    <br>
    Potem poszło na spacer, do lasu.
    <br>
    Wszystko to zaczęło się w nieznacznym czasie.
    <br>
